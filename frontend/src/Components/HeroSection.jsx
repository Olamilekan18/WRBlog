  ...
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16 bg-gray-100 dark:bg-gray-900 transition duration-300">
      ...
      <div className="md:w-1/2 text-center md:text-left">
        ...
        <button
          onClick={handleBecomeBlogger} // Add onClick handler
          className="mt-6 px-6 py-3 bg-green-500 cursor-pointer text-white rounded-lg hover:bg-green-600 dark:hover:bg-green-400 transition"
        >
          Become a blogger
        </button>
      </div>
